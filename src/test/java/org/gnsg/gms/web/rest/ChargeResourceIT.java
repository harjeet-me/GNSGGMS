...
import org.gnsg.gms.GnsggmsApp;
import org.gnsg.gms.domain.Charge;
import org.gnsg.gms.repository.ChargeRepository;
import org.gnsg.gms.repository.search.ChargeSearchRepository;
import org.gnsg.gms.service.ChargeService;
...
import org.gnsg.gms.domain.enumeration.ChargeStatus;
/**
 * Integration tests for the {@link ChargeResource} REST controller.
 */
@SpringBootTest(classes = GnsggmsApp.class)
...
public class ChargeResourceIT {
     ...
     *
     * @see org.gnsg.gms.repository.search.ChargeSearchRepositoryMockConfiguration
     */
    @Autowired
